      ...
      <section className="relative bg-gradient-to-b from-white via-cream to-warm overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-20 lg:pt-24 lg:pb-32 relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-4xl sm:text-5xl font-serif font-bold leading-tight mb-6 animate-fade-in-up animation-delay-200">
              <span className="block text-text">Et si la clé d&apos;un meilleur accompagnement</span>
              <span className="block text-green-700 italic">commençait par soi ?</span>
            </h1>
